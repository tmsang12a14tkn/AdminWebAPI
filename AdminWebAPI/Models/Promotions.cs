...
namespace AdminWebAPI.Models
{
    public partial class Promotions
    {
        ...
        public virtual PromotionDrinkSettings PromotionDrinkSettings { get; set; }
        public virtual ICollection<PromotionApplyHours> PromotionApplyHours { get; set; }
        public virtual ICollection<PromotionPhotos> PromotionPhotos { get; set; }
    }
}
